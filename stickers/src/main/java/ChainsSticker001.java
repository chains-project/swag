...
public class ChainsSticker001 extends PApplet {
    int w = 1000;
    int h = 1000;
    float cx;
    float cy;
    ...
    // select particles coordinates on a ring of diameter r
    ...
    // draw segments between points on two consecutive rings
    private void link() {
    ...
    public static void main(String[] args) {
        String[] processingArgs = { "ChainsSticker001" };
        ChainsSticker001 mySketch = new ChainsSticker001();
